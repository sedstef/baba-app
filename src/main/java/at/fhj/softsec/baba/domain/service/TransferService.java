...
public interface TransferService {
    ...
    OwnedAccount withdrawal(AuthenticatedUser authenticatedUser, Long accountNumber, BigDecimal amount) throws InsufficientFundsException;

    OwnedAccount transfer(AuthenticatedUser authenticatedUser, Long sourceNumber, Long targetNumber, BigDecimal amount) throws InsufficientFundsException;
}
